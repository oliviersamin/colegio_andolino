...
class ProfileForm(forms.Form):
    ...
    children = forms.MultipleChoiceField(required=False, label='My children', choices=CHILDREN, help_text="ejemplo por 2 niños: Gabrielle.SAMIN.GONZALEZ,Toto.SAMIN.GONZALEZ")
