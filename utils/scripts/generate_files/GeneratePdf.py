...
class GenerateInvoice(TeXfile):
    def __init__(self, mode:str, data:list[Associate]) -> None:
        self.mode = mode
        self.data = data
    ...
    def gen_files(self,):
        for associate in self.data:
            self.gen_invoice(associate)

    def gen_invoice(self, associate: Associate):
        ...
